...
class Casillas_Rellenar:
    ...
    def build(self):
        ...
        self.caja_nombre.bind("<KeyRelease>", lambda event: self.validate(event, 1))
        ...
        self.caja_apellido.bind("<KeyRelease>", lambda event: self.validate(event, 2))
        ...
        self.caja_dni.bind("<KeyRelease>", lambda event: self.validate(event, 3))
        ...
        self.boton_guardar.grid(row = 4, column = 0, padx = 10, pady = 10)
        ...
        self.boton_cancelar.grid(row = 4, column = 1, padx = 10, pady = 10)
...
class Ventana_crear_cliente(Toplevel, Casillas_Rellenar):
    ...
    def validate(self, event, index):
        ...
        self.boton_guardar.config(state = NORMAL if valido and valido_id else DISABLED)
